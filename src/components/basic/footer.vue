        ...
        <div class="w-full py-6 px-[8%] ">
            <div class="flex flex-col lg:flex-row justify-around items-start gap-6">
                ...
                <div class="w-full lg:w-1/3">
                    ...
                    <p class="lg:max-w-[70%] text-gray-600 mt-3">
                ...
                <address class="w-full lg:w-1/3 not-italic">
                    <h2 class="text-2xl font-bold">Contact Us</h2>

                    <i class="bx bxs-school flex-shrink-0 text-xl text-[#284054] mt-3"></i>
                    <p>Mullabad, Chamakkala-PO, Chenthrappinni, Thrissur-Kerala, India-680687</p>

                    <i class="bx bxs-phone flex-shrink-0 text-xl text-[#284054] mt-2"></i>
                    <p>0480 2837745</p>

                    <i class="bx bxl-gmail flex-shrink-0 text-xl text-[#284054] mt-2"></i>
